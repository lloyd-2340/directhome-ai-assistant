                        ...
                        (t, i) => {
                            ...
                            if (n) {
                                if (((t.innerHTML = ""), (t.title = n.title ?? ""), (t.className = `vapi-btn vapi-btn-is-${i}`), "connect" === n.type)) {
                                    ...
                                    (p.src =
                                        "https://media-hosting.imagekit.io/fd8693855f6d4927/Jana%20(Clear).gif?Expires=1839993533&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=0qJCXjMLN-EBXbtg0t84syW3UDs7csvG6P0bpMPZQ-UyzO004eqyj2S-rXrLSfxjz3ebwjxCBpLZSqQ0eTZyYCV6uXzXzraIaUTmB6HvRL48-8jCpRyq~fuoAEiC0-3AzTJi17uohMvt166hWhz-hjy6NPR2e6307dONzByTiKfUArITagSw1a93ICZd~25bHPFO~FXJ8H6k8vlKxr1zoSCPMXGZZbqHIGA5M6oG9KATlS-DOccK-73FKE19ylogMJgYDnR0Poo-T62DmWTqUCV5lLi~lyhGdYKw8hmvS6Z1KIc5WOnE9fvjEEaXeu6j2o4WCmvkcSbjLwOHQ9d1ug__"),
                                        (p.alt = "Agent GIF"),
